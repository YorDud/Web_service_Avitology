...
export default async function AvitoPositionsPage() {
  ...
  const capabilities = [
    ...
    },
    {
      ...
      text: "Добавляет ключевые сигналы для быстрой оценки продавца, а также максимальный доступ к анализу и сортировке полученных данных.",
    },
    {
      number: "04",
      title: "Работа на всех страницах в Авито",
      text: "Расширение HelpSell работает не только с объявлениями Авито на первой странице поиска, но и на всех последующих.",
    },
  ];
