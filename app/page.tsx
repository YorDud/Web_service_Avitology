        ...
        <div className="hero-premium-grid">
          <div className="reveal-on-scroll revealed">
            ...
            <h1 className="hero-title max-w-4xl text-black">
              HelpSell
              <span className="text-[#03bd48]"> сервис для роста продаж, </span>
  ...
  const features = [
    {
      ...
      text: "Отслеживайте динамику позиций ваших объявлений в поисковой выдаче, сохраняйте результаты анализа из расширения и сравнивайте позиции продавцов по датам — чтобы понимать своё место среди конкурентов и корректировать стратегию продвижения.",
      icon: "01",
    },
    {
      title: "Финансовый анализ",
      text: "Ведите ежедневный учёт доходов и расходов, контролируйте чистую прибыль и анализируйте динамику выручки за любой период — чтобы видеть полную финансовую картину и принимать взвешенные управленческие решения.",
      icon: "02",
    },
    {
      title: (
      <>
        Бид<ThickDash />менеджер Авито
      </>
    ),
      text: "Автоматизируйте управление ставками в рекламных кампаниях (продвижение с оплатой за просмотры или целевые действия). Сервис анализирует конкурентную среду, отслеживает позиции объявлений и автоматически корректирует стоимость клика или просмотра.",
      icon: "03",
    },
  ];
          ...
          <div className="footer-top-row">
            <div className="footer-brand-block">
              ...
              <div className="footer-brand-text">
                Современный веб-сервис для продавцов, команд и бизнеса
              </div>
            </div>
